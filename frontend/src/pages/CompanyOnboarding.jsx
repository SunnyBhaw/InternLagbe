    ...
    return (
        <div className="min-h-screen bg-bg-secondary flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8 font-sans">
            ...
            <div className="text-center mb-12">
                ...
                <h2 className="text-4xl font-black text-text-primary tracking-tight mb-3">Set up your workspace</h2>
                <p className="text-text-tertiary font-bold text-lg">Complete your business profile to start posting internships.</p>
            </div>

            {/* Form Card */}
            <div className="w-full max-w-xl bg-bg-primary border border-border-light rounded-[3rem] shadow-2xl p-10 md:p-14 relative overflow-hidden group">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <button 
                        type="submit"
                        disabled={loading}
                        className="w-full h-16 bg-primary text-text-inverse rounded-2xl font-black shadow-xl shadow-primary/20 hover:bg-primary-light transition-all flex items-center justify-center gap-3 group/btn disabled:opacity-50"
                    >
