  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen lg:h-screen bg-bg-secondary lg:overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Header - Hidden on mobile as MobileHeader provides title context or we rely on page content */}
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8 bg-bg-secondary custom-scrollbar">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="lg:hidden mb-6">
                 <h2 className="text-2xl font-black text-primary tracking-tight">Post Internship</h2>
                 <p className="text-xs text-text-tertiary font-bold uppercase tracking-widest">New Opportunity</p>
            </div>
            ...
            {success ? (
              <div className="bg-bg-primary p-8 md:p-12 rounded-[2rem] md:rounded-[2.5rem] border border-emerald-100 shadow-2xl shadow-emerald-500/5 text-center flex flex-col items-center animate-in fade-in zoom-in duration-500">
                ...
                <p className="text-text-tertiary font-bold text-sm md:text-lg">Redirecting to dashboard...</p>
              </div>
            ) : (
              <div className="bg-bg-primary rounded-[2rem] md:rounded-[2.5rem] border border-border-light shadow-lg overflow-hidden mb-8 md:12">
                <div className="p-6 md:p-10 border-b border-border-light bg-bg-tertiary/30">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-black text-primary">Internship Details</h3>
                ...
                <form onSubmit={onSubmit} className="p-6 md:p-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    ...
                    <div className="md:col-span-2">
                       <label className="block text-[10px] md:text-xs font-black text-text-tertiary uppercase tracking-widest mb-2 md:3 ml-1">Internship Title</label>
                    ...
                    {/* Skills */}
                    <div className="md:col-span-2">
                       <label className="block text-[10px] md:text-xs font-black text-text-tertiary uppercase tracking-widest mb-2 md:3 ml-1">Required Skills (Comma separated)</label>
                       <textarea
                         name="skills"
                  ...
                  <div className="mt-8 md:12">
                    <button
                      ...
                      className={`w-full py-4 md:py-5 font-black text-lg rounded-xl md:rounded-2xl shadow-xl transition-all flex items-center justify-center space-x-3 disabled:opacity-70 disabled:pointer-events-none ${
                    ...
                    >
                      {submitting ? (
                        ...
                        <>
                          <PlusCircle size={20} md:size={24} />
                          <span>{profile?.isProfileComplete ? 'Publish Now' : 'Complete Profile First'}</span>
                        </>
                      )}
                    </button>
                    {!profile?.isProfileComplete && (
                      <p className="mt-4 text-center text-[10px] font-black text-primary uppercase tracking-widest animate-pulse">
                        Setup company profile to unlock postings
                      </p>
                    )}
                  </div>
                </form>
