                ...
                <div className="flex flex-col md:flex-row gap-4 mb-10">
                    <div className="flex-1 relative group">
                        ...
                        <input 
                            ...
                            className="w-full pl-12 pr-4 py-4 bg-bg-primary border border-border-light rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all font-medium placeholder:text-text-tertiary/60 shadow-sm"
                            value={searchTerm}
